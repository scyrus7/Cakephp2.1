<h2>Edit Tag</h2>
<form action="<?php echo $this->Html->url('/tags/edit/'.$this->Html->tagValue('Tag/id')); ?>" method="post">
<div class="optional"> 
...
<ul class="actions">
<li><?php echo $this->Html->link('Delete','/tags/delete/' . $this->Html->tagValue('Tag/id'), null, 'Are you sure you want to delete: id ' . $this->Html->tagValue('Tag/id'));?>
